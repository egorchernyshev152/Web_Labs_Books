...
namespace BookStore.API.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<BooksResponse>>> GetBooks()
        {
            ...
            var response = books.Select(b => new BooksResponse(b.Id, b.Title, b.Author, b.Price));
        ...
        {
            var bookId = await _booksService.UpdateBook(id, request.Title, request.Author, request.Price);
